//g++ -Wall -o RDF_MC_Kll_test_plus `root-config --cflags --glibs ` RDF_MC_Kll_test_plus.cpp 
...
int main(int argc, char **argv){
  ...
  if(isMC){
    ...
    if(isEE) 
inputFileList.push_back(base + "BuToKJpsi_Toee_Mufilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen/crab_BuToKJpsi_Toee/191025_125913/0000/BParkNANO_mc_2019Oct25_*.root");
    else 
inputFileList.push_back(base + "BuToKJpsi_ToMuMu_probefilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen/crab_BuToKJpsi_ToMuMu/191025_125744/0000/BParkNANO_mc_2019Oct25_*.root");
  }
  else{
    std::string base = "/eos/cms//store/group/cmst3/group/bpark/BParkingNANO_2019Oct21/";
    //    inputFileList += "ParkingBPH2/crab_data_Run2018A_part2/191021_131326/0000/BParkNANO_data_2019Oct21_993.root";
  ...
  if(isMC){
    ...
    auto mc = tree_All.Define("B_l1_genParent_All", B_l1_genParent.c_str())
      ...
      .Define("GenPart_l2_pdgId_All", "Take(GenPart_pdgId, GenPart_l2_idx_All)")
      .Define("GenPart_k_pdgId_All", "Take(GenPart_pdgId, GenPart_k_idx_All)")
      .Define("GenMothPart_l1_idx_All", "Take(GenPart_genPartIdxMother, GenPart_l1_idx_All)")
      .Define("GenMothPart_l2_idx_All", "Take(GenPart_genPartIdxMother, GenPart_l2_idx_All)")
      .Define("GenMothPart_k_idx_All", "Take(GenPart_genPartIdxMother, GenPart_k_idx_All)")
      .Define("GenMothPart_l1_pdgId_All", "Take(GenPart_pdgId, GenMothPart_l1_idx_All)")
      .Define("GenMothPart_l2_pdgId_All", "Take(GenPart_pdgId, GenMothPart_l2_idx_All)")
      .Define("GenMothPart_k_pdgId_All", "Take(GenPart_pdgId, GenMothPart_k_idx_All)")
      .Define("GenGMothPart_l1_idx_All", "Take(GenPart_genPartIdxMother, GenMothPart_l1_idx_All)")
      .Define("GenGMothPart_l2_idx_All", "Take(GenPart_genPartIdxMother, GenMothPart_l2_idx_All)")
      .Define("GenGMothPart_k_idx_All", "Take(GenPart_genPartIdxMother, GenMothPart_k_idx_All)")
      .Define("GenGMothPart_l1_pdgId_All", "Take(GenPart_pdgId, GenGMothPart_l1_idx_All)") 
      .Define("GenGMothPart_l2_pdgId_All", "Take(GenPart_pdgId, GenGMothPart_l2_idx_All)") 
      .Define("GenGMothPart_k_pdgId_All", "Take(GenPart_pdgId, GenGMothPart_k_idx_All)")
      .Define("GenPart_l1_eta_All", "Take(GenPart_eta, GenPart_l1_idx_All)")
      .Define("GenPart_l2_eta_All", "Take(GenPart_eta, GenPart_l2_idx_All)")
      .Define("GenPart_k_eta_All", "Take(GenPart_eta, GenPart_k_idx_All)")
      .Define("GenPart_l1_phi_All", "Take(GenPart_phi, GenPart_l1_idx_All)")
      .Define("GenPart_l2_phi_All", "Take(GenPart_phi, GenPart_l2_idx_All)")
      .Define("GenPart_k_phi_All", "Take(GenPart_phi, GenPart_k_idx_All)");


    std::cout << " flagGenMatched" << std::endl;
    auto mcGenMatched = mc.Define("isGenMatched_All", flagGenMatchExt, {"isResonant_All", "GenPart_l1_pdgId_All", "GenPart_l2_pdgId_All", 
      ...
      .Define("dRwithGen_All", computedR, {"isGenMatched_All", 
	                                   "GenPart_l1_eta_All", "GenPart_l2_eta_All", "GenPart_k_eta_All", "B_l1_eta_All", "B_l2_eta_All", "B_k_eta_All", 
	                                   "GenPart_l1_phi_All", "GenPart_l2_phi_All", "GenPart_k_phi_All", "B_l1_phi_All", "B_l2_phi_All", "B_k_phi_All"})
    ...
    */
    tree_All.Snapshot("newtree", Form("newfile_isMC%d_isEE%d_All.root", isMC, isEE), listColumns_All);
  }
